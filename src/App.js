  ...
  render() {
    return (
      <div>
        ...
        <NavBar/>
        <Routes>
          <Route exact path='/' element = {<News key="genaral" pageSize={5} country='in' category = 'general'/>}/>
          ...
          <Route exact path='/general' element = {<News key="genaral" pageSize={5} country='in' category = 'general'/>}/>
